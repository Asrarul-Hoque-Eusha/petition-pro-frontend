...
interface Props {
  index: number;
  onPatentChange: (index: number, data: PatentData) => void;
}

const PatentSection: React.FC<Props> = ({ index, onPatentChange }) => {
  ...
  const handleInputChange = (key: keyof PatentData, value: string) => {
    const updated = { ...formData, [key]: value };
    setFormData(updated);
    onPatentChange(index, updated);
  };
